...
\noindent\textbf{問4}
\vspace{0.4em}
\listeningqFourBlankSetup

\noindent No.\,1\quad He enjoyed it in a tent on \listeningblank[the lake]{\listeningqFourBlankA} （4点）

\vspace{1em}

\noindent No.\,2\quad He \listeningblank[cooked fish]{\listeningqFourBlankB} and ate them with Tomoya. （4点）
...
\noindent\textbf{4. 第4回（比較級・最上級・原級）}（10点）
...
\testqsep
\testquestion
\noindent\textbf{【問17】} 次の英文を意味を変えないように書き換えなさい。
...
\testqsep
\testquestion
\noindent\textbf{【問19】} 次の英文に対する答えを主語と動詞を含む英文1文で答えなさい。
...
\vspace{2em}
\begin{enumerate}
    \item \testfitblankbf[]{biggest}
\vspace{1.5em}
    \item is \testfitblankbf[\text{studying English hard every day}]{30}.
\vspace{1.5em}
    \item \wordentryrowsix{6}{First,}{I}{made}{many}{new}{friends.}

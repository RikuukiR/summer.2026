...
case "$TARGET" in
  confirm)
    build_test "test-main.tex" "第5回 確認テスト.pdf" "第5回 確認テスト"
    ;;
  review)
    build_test "review-main.tex" "第5回 復習テスト.pdf" "第5回 復習テスト"
    ;;
  all)
    build_test "test-main.tex" "第5回 確認テスト.pdf" "第5回 確認テスト"
    build_test "review-main.tex" "第5回 復習テスト.pdf" "第5回 復習テスト"
    ;;
  *)
    echo "用法: build-test-5.sh [confirm|review|all]" >&2
    exit 1
    ;;
esac

...
\newcommand{\fitblankbfshort}[1]{%
  \ifshowanswer
    \underline{\makebox[4.6em][c]{{\color{blue}\textbf{#1}}}}%
  \else
    \underline{\makebox[4.6em][c]{\phantom{\textbf{#1}}}}%
  \fi
}
...
\setlength{\compareexwd}{0.44\linewidth}
...
\newcommand{\compareexrow}[2]{%
  \par\vspace{0.5em}%
  \noindent
  \begin{minipage}[t]{\compareexwd}#1\end{minipage}\hfill
  \begin{minipage}[t]{\compareexwd}#2\end{minipage}%
  \par\vspace{0.25em}%
}
\newlength{\praccolwd}
...
\newcommand{\dialogueblankprac}[1]{%
  ...
  \noindent
  \ifshowanswer
    \underline{\makebox[\linewidth][l]{\hspace{0.5em}{\color{blue}\small #1}\hspace{0.5em}}}%
  \else
    \underline{\makebox[\linewidth][l]{\hspace{0.5em}{\small\phantom{#1}}\hspace{0.5em}}}%
  \fi
  \par\vspace{0.12em}%
}
